...
import io.shick.shiken.web.filter.CachingHttpHeadersFilter;
import io.shick.shiken.web.filter.StaticResourcesProductionFilter;
import io.shick.shiken.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        parameters.put("instance-name", "shiken");
